...
MODEL_PATH = os.path.join(BASE_DIR, "3layerMLPparameter/3layermlp8_10ep_torch_with_adam_100_50.pth")
...
class TactileMLP(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.transpose(1, 2)      # (B, 100, 50)
        x = x.reshape(B, -1)       # (B, 5000)
